...
import {
  ...
  TeamOutlined,
  UserOutlined,
  YoutubeOutlined, // 👈 Naya Icon link kiya
} from "@ant-design/icons";
import { useState } from "react";
import Cookies from "js-cookie";
import Dashboard from "../../pages/Dashboard";
import StudentManagement from "../../pages/StudentManagement";
import VideoManagement from "../../pages/VideoManagement"; // 👈 Import kiya naya page
      ...
      <Layout style={{ backgroundColor: "#fffaf3" }}>
        ...
        <Content className="m-6">
          {key === "1" ? (
            ...
            <VideoManagement /> // 🌟 CONDITIONALLY RENDERING VIDEO COMPONENT
          ) : (
            <div className="bg-white p-6 rounded-xl shadow-sm text-center font-medium text-gray-500">
              Coming Soon... Component for Key {key} is under development.
            </div>
